...
static void GenerateTraffic (Ptr<Socket> socket, std::string message, Time pktInterval, int id, int index)
{
            ...
            if (msg[0] == "COORDINATES") {
                ...
                for (int i = 0; i < vehicle_number - 1; i++) {
                    ...
                    Simulator::ScheduleWithContext (source->GetNode ()->GetId (),
                            ...
                            source, data_string, interPacketInterval, id+1, i);                    
                }
                Simulator::Run ();
...
int main (int argc, char *argv[])
{
    ...
    manage_data(phyMode, rss, packetSize, numPackets, interval, verbose);
    return 0;
}